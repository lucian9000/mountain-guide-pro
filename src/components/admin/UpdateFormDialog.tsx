      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <DialogFooter>
          ...
          <button
            ...
            onClick={() => void save()}
            className="inline-flex items-center gap-2 bg-accent hover:bg-cyan-hover text-accent-foreground px-5 py-2 rounded-lg font-heading font-bold text-xs tracking-wider uppercase shadow-button transition-colors disabled:opacity-60"
          >
