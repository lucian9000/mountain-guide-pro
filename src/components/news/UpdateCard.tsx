    ...
    <div className="p-5 flex flex-col gap-2 flex-1">
      ...
      {update.route && (
        <Link
          ...
          className="mt-auto pt-2 inline-flex items-center gap-1 min-h-[44px] text-accent hover:text-cyan-soft font-heading font-bold text-xs tracking-wider uppercase transition-colors"
        >
