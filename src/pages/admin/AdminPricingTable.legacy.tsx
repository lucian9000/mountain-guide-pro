// LEGACY — the inline pricing table used before Phase 6.
// Retained on disk per the Phase 6 brief but intentionally UNREFERENCED:
// AdminPricing.tsx now renders card + dialog editing instead.
...
export default AdminPricingTableLegacy;
